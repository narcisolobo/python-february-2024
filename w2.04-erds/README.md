...
## MySQL Data Types
Just like our values have data types in Python, we can also define data types for our columns in MySQL.

[This module in the Learn Platform](https://login.codingdojo.com/m/506/12461/87376) has the definitions of the data types we will use in this course.
...
- MacOS Sonoma students - save your `.vuerd.json` files and include them with your assignment submissions.

**If you do not include these files, your instructors and/or teaching assistants will not be able to check your work.**
...
In this course, we will be primarily working with **one-to-many** relationships. We also discuss **one-to-one** relationships. Those of you who are vying for a black belt on the exam should also understand **many-to-many** relationships.
